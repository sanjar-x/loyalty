...
| combined-batch-mail-types | Массив (Опционально) | Вид РПО |
...
| electronic-f103 | Логическое | Электронная Ф103 |
| fragile-rate | Целое число (Опционально) | Плата за услугу "Осторожно, хрупкое, терморежим" без НДС |
| fragile-rate-vat | Целое число (Опционально) | Плата за услугу "Осторожно, хрупкое, терморежим" с НДС |
...
| international | Логическое (Опционально) | Признак международной почты |
| is-postoffice-ukd | Логическое | Является ли место приема УКД |
...
| mail-rank | Строка (Опционально) | Разряд письма |
...
| pre-postal-preparation | Логическое (Опционально) | Предпочтовая подготовка |
...
| ukd | Логическое | УКД |
| use-online-balance | Логическое (Опционально) | Признак использования онлайн-баланса |
| wo-mass | Логическое (Опционально) | Без указания массы |
