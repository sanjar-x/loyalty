...
Post-ADR-011: customs fields moved to ``PassportSnapshot`` (see
``tests/unit/modules/order/test_passport_snapshot.py``). This file
covers the shipping-only RecipientSnapshot invariants.
"""
