...
PATH_REQUEST_EDIT_STATUS = "/api/b2b/platform/request/edit/status"
PATH_REQUEST_DATETIME_OPTIONS = "/api/b2b/platform/request/datetime_options"
PATH_REQUEST_REDELIVERY_OPTIONS = "/api/b2b/platform/request/redelivery_options"
PATH_REQUEST_PLACES_EDIT = "/api/b2b/platform/request/places/edit"
PATH_REQUEST_ITEMS_INSTANCES_EDIT = "/api/b2b/platform/request/items-instances/edit"
PATH_REQUEST_ITEMS_REMOVE = "/api/b2b/platform/request/items/remove"
