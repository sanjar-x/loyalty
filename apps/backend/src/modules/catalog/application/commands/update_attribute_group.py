...
Applies partial updates to name and sort order. Code is immutable.
...
class UpdateAttributeGroupResult:
    ...
    Attributes:
        ...
        code: Immutable machine-readable code.
...
class UpdateAttributeGroupHandler:
    ...
    async def handle(
        ...
        self._logger.info("Attribute group updated", group_id=str(group.id))
