  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <section className="flex flex-col gap-3">
        ...
        <div className="bg-app-bg-soft grid grid-cols-2 gap-3 rounded-xl p-4 text-sm md:grid-cols-3">
      ...
      <section className="flex flex-col gap-3">
        ...
        {loading ? (
          ...
          <p className="text-app-muted bg-app-bg-soft rounded-xl p-4 text-sm">
