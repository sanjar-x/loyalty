...
const ERROR_MESSAGES = {
  ...
  PRICING_CONTEXT_VERSION_CONFLICT:
    'Контекст был изменён другим пользователем. Обновите страницу',
  ...
  PRICING_VARIABLE_IN_USE:
    'Переменная используется — сначала удалите все ссылки',
  ...
  PRICING_VARIABLE_DATA_TYPE_IMMUTABLE:
    'Тип данных нельзя изменить после создания',
  PRICING_FORMULA_VERSION_NOT_FOUND: 'Версия формулы не найдена',
  PRICING_FORMULA_VERSION_CONFLICT:
    'Формула была изменена другим пользователем',
