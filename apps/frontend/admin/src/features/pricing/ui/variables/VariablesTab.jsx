    ...
    <div className="flex flex-col gap-4">
      <div className="flex items-center justify-between gap-3">
            ...
            <button
              ...
              className={cn(
                ...
                scopeFilter === f.value
                  ...
                  : 'bg-app-card text-app-text hover:bg-app-divider-strong',
              )}
            >
              {f.label}
            </button>
        ...
        <button
          ...
          className="bg-app-text shrink-0 rounded-lg px-4 py-2 text-sm font-medium text-white transition-opacity hover:opacity-90"
        >
          + Добавить
        </button>
      </div>
      ...
      {loading ? (
        ...
        <EmptyState
          ...
          description={
            scopeFilter
              ? 'Нет переменных с выбранным scope.'
              : 'Добавьте первую переменную для формулы ценообразования.'
          }
          action={
            !scopeFilter
              ? {
