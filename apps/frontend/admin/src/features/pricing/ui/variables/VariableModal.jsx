    ...
    try {
      if (isEdit) {
        const patch = {
          ...
          isRequired,
          expectedVersionLock: variable.versionLock,
        };
        if (defaultValue !== (variable.defaultValue ?? '')) {
          patch.defaultValue = defaultValue || null;
          patch.defaultValueProvided = true;
        }
        if (isFxRate && maxAgeDays !== (variable.maxAgeDays ?? '')) {
          patch.maxAgeDays = maxAgeDays ? Number(maxAgeDays) : null;
          patch.maxAgeDaysProvided = true;
        }
        ...
        if (isFxRate && maxAgeDays) payload.maxAgeDays = Number(maxAgeDays);
