  ...
  return (
    <div className={styles.metricsGrid}>
      ...
      <div>
        ...
        <div className="text-app-text-secondary flex items-center gap-1 text-base leading-5 font-medium">
          <DateRangePicker
            value={dateRange}
          ...
          {hasRange && (
            <button
              ...
              className="text-app-text-secondary cursor-pointer border-0 bg-transparent p-0 text-xl leading-none"
