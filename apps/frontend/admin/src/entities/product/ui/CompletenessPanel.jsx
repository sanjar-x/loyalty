          ...
          <ul className="space-y-0.5">
            {missingRequired.map((attr) => (
              <li
                ...
                title={attr.code ?? attr.attributeId}
              >
                <span className="text-red-500">*</span>
                {/* Backend invariant: `code` is always set; nameI18N may be
                    empty for attrs that admin hasn't translated yet. Fall
                    back to code so the row is at least identifiable. */}
