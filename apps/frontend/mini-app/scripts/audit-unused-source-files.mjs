...
const SOURCE_DIRS = ['app', 'components', 'features', 'lib', 'store', 'telegram', 'ios'];

const EXTS = ['.js', '.jsx', '.ts', '.tsx', '.mjs', '.cjs', '.css', '.module.css'];
const CODE_EXTS = new Set(['.js', '.jsx', '.ts', '.tsx', '.mjs', '.cjs']);
const TEXT_EXTS = new Set(['.js', '.jsx', '.ts', '.tsx', '.mjs', '.cjs', '.css']);
...
function extractSpecifiers(text) {
  ...
  const reFrom = /\b(?:import|export)\s+(?:type\s+)?[\s\S]*?\sfrom\s*["']([^"']+)["']/g;
