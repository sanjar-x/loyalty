...
export default function SearchOverlay({
  ...
  // Backend `q minLength: 2` (Spec §6) — a 1-character query returns 422.
  // Guard both at the RTKQ level and here.
  ...
  // History entries are returned by `lib/search/history.js` sorted by
  // searchedAt DESC and dedup-pruned. The UI shows only 12.
  ...
  // Skeleton — visible only during the first mount (localStorage reads are
  // synchronous, but the RTKQ initial fetch cycle takes one tick).
