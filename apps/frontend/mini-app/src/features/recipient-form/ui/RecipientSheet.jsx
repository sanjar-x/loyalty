...
import { useRecipientForm } from '@/features/recipient-form/model/useRecipientForm';
import {
  PHONE_FORMATS,
...
/**
 * CHK-021: mask phone as "+7 9** *** ** 23" — for display in the
 ...
 * @param {(payload: import("@/features/recipient-form/model/useRecipientForm").RecipientDraft) => void} props.onSave
