// =============================================================================
// Barrel export — features/telegram
// =============================================================================
...
export type {
  ...
  CloudStorage as CloudStorageType,
  DeviceStorage as DeviceStorageType,
  SecureStorage as SecureStorageType,
  BiometricManager as BiometricManagerType,
  LocationManager as LocationManagerType,
  LocationData,
  Accelerometer as AccelerometerType,
  Gyroscope as GyroscopeType,
  DeviceOrientation as DeviceOrientationType,
  SafeAreaInset,
...
export {
  ...
  isVersionAtLeast,
  supportsFeature,
  TelegramNotAvailableError,
  TelegramFeatureNotSupportedError,
...
// Provider
export type { TelegramContextValue, TelegramSdkProviderProps } from './provider';
export { TelegramSdkProvider, useTelegramContext } from './provider';
...
// Components
export { TelegramEnvironmentAlert } from './components/telegram-environment-alert';
export { TelegramBackButtonController } from './components/telegram-back-button-controller';
