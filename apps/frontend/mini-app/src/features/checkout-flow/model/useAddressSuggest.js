...
/**
 * Address suggest (geo subdivision) — query with 250ms debounce, AbortController
 * cancel. Audit #1: extracted from `app/checkout/pickup/page.jsx`. Fully
 * self-contained — no input required.
 *
 * BFF route: `POST /api/geo/suggest/address` — proxy to our backend's geo catalog
 * (response is preserved in DaData shape).
 *
 * @returns {{
 *   query: string,
