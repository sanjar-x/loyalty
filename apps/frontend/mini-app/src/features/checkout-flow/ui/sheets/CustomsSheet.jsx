...
import { CUSTOMS_INFO_URL, INN_LOOKUP_URL } from '@/features/checkout-flow/lib/constants';
import { useCustomsForm } from '@/features/checkout-flow/model/useCustomsForm';
 ...
 * `useCustomsForm` hook ichida. CHK-022: FormField floating-label
 * pattern.
 *
 * @param {Object} props
 * @param {boolean} props.open
 * @param {() => void} props.onClose
 * @param {(payload: import("@/features/checkout-flow/model/useCustomsForm").CustomsDraft) => void} props.onSave
 * @param {Partial<import("@/features/checkout-flow/model/useCustomsForm").CustomsDraft> | null} [props.initialValue]
 */
