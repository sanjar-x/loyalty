...
/**
 * Bottom-sheet modal describing loyalty points (per Figma node 0-12811).
 */
        ...
        <div className={styles.sheet}>
          ...
          <div className={styles.body}>
            <section className={styles.block}>
              ...
              <p className={styles.text}>За каждый завершённый заказ начисляется 200 баллов.</p>
            </section>

            <section className={styles.block}>
              <h3 className={styles.blockTitle}>Как потратить?</h3>
              <p className={styles.text}>
                Баллами можно оплачивать часть заказа: до 10% на стартовом уровне, до 15% на
                продвинутом и до 20% на премиум.
              </p>
            </section>
            ...
            <section className={styles.block}>
              <h3 className={styles.blockTitle}>Как получить?</h3>
              <p className={styles.text}>
                Подарочные баллы начисляются при активации подарочной карты, полученной от другого
                пользователя.
              </p>
            </section>
            ...
            <section className={styles.block}>
              <h3 className={styles.blockTitle}>Как потратить?</h3>
              <p className={styles.text}>
                Подарочными баллами можно оплачивать до 100% стоимости заказа. При их наличии они
                всегда списываются первыми, пока не израсходуются полностью.
              </p>
            </section>
          </div>
