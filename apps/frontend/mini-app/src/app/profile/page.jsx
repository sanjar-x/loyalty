...
import ProfileHeader from '@/widgets/ProfileMenu/ProfileHeader';
import MenuSection from '@/widgets/ProfileMenu/ProfileMenuSection';
...
export default function ProfilePage() {
  ...
  // The user from Telegram initData — fallback for name/username while
  // `me` (backend profile) hasn't arrived yet. The provider is SSR-safe
  // (`user: null`).
  ...
  const displayName =
    fullName || username || tgId || (isLoading || isFetching ? 'Загрузка…' : 'Пользователь');
  ...
  return (
    <div className={styles.page}>
      <Header title="Профиль" showClose={false} showMore={false} />
