...
import { cn as clsx } from '@/shared/lib/ui-utils';
...
export default function ReviewsPage() {
  ...
  // Backend Reviews module doesn't exist yet (Spec §11) — empty start.
  // When the module is ready, this hooks into `usePendingReviewsQuery` / `useMyReviewsQuery`.
