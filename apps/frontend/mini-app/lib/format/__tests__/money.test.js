...
describe('Money — kopecks-first qiymat tipi', () => {
  ...
  it('non-integer kopecks rejected (float xatolarni oldini olish)', () => {
  ...
  it("add/subtract — birlamchi summa to'g'ri (float xatosiz)", () => {
    // 0.1 + 0.2 RUB = 30 kopecks (float'da 0.30000000000000004)
  ...
  it('immutability — qaytgan obyekt frozen', () => {
...
describe('Money — public aliaslar (CHK-007)', () => {
