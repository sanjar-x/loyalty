/**
 * RTKQ endpoint enhancement config'lari — Products / Profile / Search / Media.
 * `instance.js` buni `enhanceEndpoints({ endpoints })` ga spread qiladi.
 */
import { mapStorefrontProduct, unwrapPLPResponse } from '@/lib/adapters/mapStorefrontProduct';
import { transformForYouFeed } from '@/lib/store/transformers';
