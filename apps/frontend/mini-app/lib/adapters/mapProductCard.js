 ...
 *
 * Bitta source-of-truth: `app/page.jsx`, `app/cart/page.jsx`,
 ...
 *
 * Narx formatlovchi — `formatRubFloat` (`./price`); ilgari mahalliy
 * `formatRubPrice` edi, dedup qilingan (naming code review).
 * Foto kandidatlar — modul-private; eksport variant `./favoriteAssets`'da.
 */

import { buildBackendAssetUrl, buildProductPhotoUrl } from '@/lib/url/backendAssets';
import { formatRubFloat } from '@/lib/format/price';
