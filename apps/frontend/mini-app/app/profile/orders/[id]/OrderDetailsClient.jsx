...
import { useGetOrderByIdQuery } from '@/lib/store/api';
...
export default function OrderDetailsClient({ id, variant }) {
  ...
  // Backend Orders moduli yo'q (Spec §11) — ghost endpoint hozircha `null` qaytaradi.
  // Modul tayyor bo'lganda `lib/store/api.js#getOrderById`'ni real fetch'ga ulash kifoya.
