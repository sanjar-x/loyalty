...
export default function PromoCodesPage() {
  ...
  // Backend Promo moduli yo'q (Spec §11) — bo'sh ro'yxat. Modul tayyor bo'lganda
  // RTKQ'dan `usePromoCodesQuery` orqali to'ldiriladi. Empty state allaqachon
  // mavjud — promokodlar tushganda avtomatik to'ldiriladi.
