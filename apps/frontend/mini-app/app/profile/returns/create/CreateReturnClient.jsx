...
export default function CreateReturnClient() {
  ...
  // Draft `localStorage`'dan keladi — `/profile/returns` sahifasida zakaz
  // tanlanganida `saveReturnDraft` yoziladi. Backend Returns moduli yo'q
  // (Spec §11), shuning uchun draft yo'q bo'lsa foydalanuvchini ortga
  // yo'naltiramiz — buzuq mock product ko'rsatish o'rniga.
