...
import PointsHistory from '@/components/blocks/promo/PointsHistory';
...
export default function PromoPage() {
  // Backend Loyalty Points moduli yo'q (Spec §11). Modul tayyor bo'lganda
  // RTKQ'dan `useMyPointsQuery` orqali points/giftPoints qiymatlari keladi.
  const points = null;
