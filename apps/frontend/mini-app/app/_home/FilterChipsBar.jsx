...
/**
 * Bosh sahifa filtr-chip paneli (sort / filters / category / type / brand /
 * price / original / delivery). Audit #1: `app/page.jsx` god-komponentidan
 * ajratilgan ~210-satrli JSX — sof presentation.
 *
 * Sahifa uni `showResults && !showOverlay` da render qiladi. Xulq uchta
 * callback orqali keladi: `onOpenSheet(name)` / `onClearFilter(name)` /
 * `onToggleOriginal()`.
 */
