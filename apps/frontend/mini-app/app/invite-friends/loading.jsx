  ...
  return (
    <main className={cn('tg-viewport', styles.page)} aria-busy="true">
      <Container className={styles.container}>
        ...
        <section className={styles.promoCard} aria-label="Промокод" aria-hidden="true">
        ...
        <section className={styles.statsCard} aria-label="Статистика" aria-hidden="true">
        ...
        <section className={styles.history} aria-label="История приглашений" aria-hidden="true">
