...
import { PVZ_PROVIDERS } from '@/lib/checkout/pvzProviders';

import styles from './page.module.css';

/**
 * PVZ provider filter chip'lari (Все / CDEK / Яндекс). Audit #1:
 * `app/checkout/pickup/page.jsx` god-komponentidan ajratilgan presentation.
 *
 * `ProviderIcon` lokal — faqat shu komponent ichida ishlatiladi.
 */
