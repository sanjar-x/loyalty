...
export default function ProductImageGallery({
  ...
  // Desktop swipe — touch'da hook avtomatik o'chiriladi. Hook har render'da
  // chaqiriladi (Rules of Hooks), `variant` o'zgarsa ham react buni xavfsiz
  // boshqaradi. `ref` faqat strip variantidagi `<div>`'ga ulanadi.
