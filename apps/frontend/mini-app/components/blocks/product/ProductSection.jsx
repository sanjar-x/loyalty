...
export default function ProductSection({
  ...
  // Desktop drag-to-scroll + wheel proxy faqat horizontal layout uchun.
  // Mobile/touch'da hook o'zi `pointerType === "touch"` early-return
  // qiladi, demak native swipe to'liq saqlanadi.
