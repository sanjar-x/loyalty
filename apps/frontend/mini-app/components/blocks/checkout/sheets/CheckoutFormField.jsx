...
import styles from './CheckoutFormField.module.css';

/**
 * CHK-022 Layer 2: shared floating-label form field for checkout sheets.
 *
 * Props are intentionally minimal — sheets pass everything through. The
