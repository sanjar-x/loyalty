...
export default function BottomSheet({
  ...
  const sheet = (
    <div
      className={`${styles.root} ${isFilter ? styles.rootFilter : ''}`}
      role="dialog"
      aria-modal="true"
    ...
    >
      ...
      <div
        ...
        onClick={(e) => e.stopPropagation()}
        style={{ minHeight: isFilter ? '100dvh' : isTypeModule ? '80vh' : 'auto' }}
      >
        <div
          ...
          <div
            ...
            style={
              isFilter
                ? {}
                : {
                    // CHK-022 Layer 1.1: 446px hardcoded → dynamic (85vh / viewport
                    // - 80px for header + grabber + footer). Content overflow uchun
                    // internal scroll faqat haqiqatdan kerak bo'lganda.
                    maxHeight: isReview
                      ? 'auto'
                      : 'calc(min(85vh, var(--tg-viewport-stable-height, 100vh)) - 80px)',
                  }
            }
          >
            {children}
