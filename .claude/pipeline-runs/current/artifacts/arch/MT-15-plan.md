# MT-15 Architecture Plan (Simple — Application Layer)
...
**Implementation:** Follow pm-spec.md MT-15 section exactly. Follow existing handler patterns in the codebase.
