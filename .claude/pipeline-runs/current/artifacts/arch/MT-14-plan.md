# MT-14 Architecture Plan (Simple — Application Layer)
...
**Implementation:** Follow pm-spec.md MT-14 section exactly. Follow existing handler patterns in the codebase.
