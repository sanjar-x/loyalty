# MT-11 Architecture Plan (Simple — Application Layer)
...
**Implementation:** Follow pm-spec.md MT-11 section exactly. Follow existing handler patterns in the codebase.
