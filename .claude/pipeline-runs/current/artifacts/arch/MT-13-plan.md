# MT-13 Architecture Plan (Simple — Application Layer)
...
**Implementation:** Follow pm-spec.md MT-13 section exactly. Follow existing handler patterns in the codebase.
