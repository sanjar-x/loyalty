# MT-12 Architecture Plan (Simple — Application Layer)
...
**Implementation:** Follow pm-spec.md MT-12 section exactly. Follow existing handler patterns in the codebase.
