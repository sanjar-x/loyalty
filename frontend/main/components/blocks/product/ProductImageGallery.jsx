...
export default function ProductImageGallery({
  ...
  const safeIndex = count > 0
    ? Math.min(Math.max(currentImageIndex ?? 0, 0), count - 1)
    : 0;
  ...
  const translateX = liveOffset !== 0
    ? `calc(${-safeIndex * 100}% + ${liveOffset}px)`
    : `${-safeIndex * 100}%`;
      ...
      >
        ...
        <div className={styles.c6}>
          <div className={cx(styles.c7, styles.tw1)}>
            ...
            >
              <Image
                src={isFavorite ? "/icons/global/active-heart.svg" : "/icons/product/black-stroke-heart.svg"}
                alt="Избранное"
                width={22}
                height={20}
