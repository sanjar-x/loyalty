...
const cards = [
  ...
  { title: "POIZON –\n только\n оригинал", icon: "/img/FriendsSection6.webp", href: "https://teletype.in/@loyaltymarket/poizon-only-original" },
          ...
          <div key={c.title} className={styles.item}>
            {c.href ? (
              <div
                role="button"
                tabIndex={0}
                style={{ textDecoration: "none", color: "inherit", cursor: "pointer", WebkitTapHighlightColor: "transparent" }}
                onClick={() => {
