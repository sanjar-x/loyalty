...
export function mapPickupPoint(p) {
  ...
  return {
    ...
    workSchedule:
      typeof p.work_schedule === "string" && p.work_schedule.trim()
        ? p.work_schedule.trim()
        : null,
    ...
    weightLimitGrams:
      typeof p.weight_limit_grams === "number" ? p.weight_limit_grams : null,
