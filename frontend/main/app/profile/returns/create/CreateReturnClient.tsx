...
type PhotoState = Record<string, PhotoData | null>;
...
export default function CreateReturnClient() {
  ...
  const product: ReturnProductData = (draft?.product as ReturnProductData) ?? {
  ...
  function handlePickPhotos(slotId: string) {
          ...
          <div className={styles.productRow}>
            ...
            <div className={styles.productMeta}>
              ...
              <div className={styles.productSub}>
                Размер: <span>{product.size}</span> &middot; Артикул:{" "}
