...
import { useListOrdersQuery } from "@/lib/store/api";
...
export default function OrdersClient() {
  ...
  // Backend Orders moduli hali yo'q (Spec §11) — RTKQ ghost endpoint bo'sh ro'yxat
  // qaytaradi. Modul tayyor bo'lganda `lib/store/api.js#listOrders`'ni real
  // fetch'ga ulash kifoya — UI hech qanday o'zgarishsiz ishlaydi.
        ...
        {orders.length > 0 ? (
          ...
          <section className={styles.emptyState} role="status" aria-live="polite">
            ...
            <div className={styles.emptyText}>
              Здесь будут отображаться все ваши заказы
            </div>
          </section>
        )}
      </main>
