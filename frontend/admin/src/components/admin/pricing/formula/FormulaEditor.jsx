  ...
  return (
    <div className="flex flex-col gap-1">
      ...
      {!readOnly && (
        <button
          onClick={addBinding}
          className="mt-1 flex items-center gap-2 self-start rounded-lg px-3 py-2 text-sm font-medium text-app-muted transition-colors hover:bg-[#f4f3f1] hover:text-app-text"
        >
