...
export function BindingRow({
  ...
  return (
    <div
      className={cn(
        'group flex flex-col gap-1.5 rounded-xl px-3 py-2.5 transition-colors',
        'hover:bg-[#fafafa]',
    ...
    >
      <div className="flex items-center gap-2">
        <input
          ...
          className={cn(
            'h-7 w-44 rounded-md border border-transparent bg-transparent px-2 font-mono text-sm text-app-text outline-none transition-colors',
        ...
        <select
          ...
          disabled={readOnly}
          className={cn(
            'h-7 w-32 rounded-md border border-app-border bg-white px-1.5 text-[11px] text-app-muted outline-none',
        ...
        {!readOnly && (
          <div className="flex items-center gap-0.5 opacity-0 transition-opacity group-hover:opacity-100">
            <div className="flex flex-col">
              {index > 0 && (
                <button onClick={onMoveUp} className="rounded p-0.5 text-app-muted hover:text-app-text" title="Вверх">
              ...
              {index < totalCount - 1 && (
                <button onClick={onMoveDown} className="rounded p-0.5 text-app-muted hover:text-app-text" title="Вниз">
                  <svg className="h-3 w-3" viewBox="0 0 12 12" fill="none" stroke="currentColor" strokeWidth="1.5">
            ...
            {!isFinalPrice && (
              <button onClick={onRemove} className="rounded p-0.5 text-app-muted hover:text-red-500" title="Удалить">
