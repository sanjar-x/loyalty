...
export function Sidebar() {
  ...
  return (
    <>
      <aside className="sticky top-0 hidden h-screen w-54 bg-[#2d2d2d] px-4 py-5 text-white md:flex md:flex-col">
      ...
      <div className="mb-5 rounded-2xl bg-[#2d2d2d] p-3 text-white md:hidden">
