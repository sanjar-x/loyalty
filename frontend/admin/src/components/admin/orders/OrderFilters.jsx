...
export function OrderFilters({
  ...
  return (
    <div className="my-4 flex flex-wrap items-center gap-3">
      <div className="flex h-[46px] w-full items-center gap-[10px] rounded-[50px] bg-[#f4f3f1] px-[13px] py-3 sm:w-[306px]">
      ...
      {isTransitMode && (
        <button
          type="button"
          className="inline-flex h-[46px] items-center gap-[10px] rounded-[50px] bg-[#2d2d2d] px-[13px] py-3 text-base leading-5 font-medium text-[#9e9e9e]"
        >
      ...
      <button
        type="button"
        onClick={onReset}
        className="inline-flex h-[46px] items-center justify-center px-2 text-[36px] leading-none text-[#2d2d2d]"
