          ...
          return (
            <div key={val.id} className={styles.attrSwatchItem}>
              <button
                type="button"
                className={
                  isActive ? styles.attrSwatchActive : styles.attrSwatch
                }
                onClick={() => onToggle(val.id)}
                aria-label={name}
                title={name}
...
function DropdownField({ attribute, selected, onChange }) {
  ...
  const selectedLabel = selectedVal
    ? i18n(selectedVal.valueI18N, selectedVal.code)
    : '';
    ...
    >
      ...
      >
        <span
          className={
            selectedLabel
              ? styles.attrDropdownValue
              : styles.attrDropdownPlaceholder
          }
        >
          {selectedLabel || 'Выберите'}
        </span>
        <span
          className={styles.attrDropdownChevron}
                ...
                return (
                  ...
                  >
                    ...
                    <span className={styles.attrDropdownCheck}>
                      {isSelected && (
                        <span className={styles.attrDropdownCheckInner} />
                      )}
                    </span>
                  </button>
                );
