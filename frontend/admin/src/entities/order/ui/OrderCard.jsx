...
function StatusButton({ label, withEdit = false, className, onClick }) {
  return (
    <button
      ...
      className={cn(
        'text-app-text-dark inline-flex h-[38px] items-center gap-2 rounded-[12px] bg-white px-4 text-base leading-5 font-medium',
        className,
      )}
    >
...
export function OrderCard({ order, onOpenStatusModal }) {
  ...
  return (
    <div
      ...
      className="bg-app-card cursor-pointer overflow-hidden rounded-2xl"
    >
              ...
              <div className="flex min-w-0 items-start gap-3 text-left">
                ...
                <div className="min-w-0">
                  <div className="grid grid-cols-1 gap-y-1 sm:grid-cols-[246px_60px] sm:items-start sm:gap-x-[85px]">
                    ...
                    <p className="text-app-text-dark h-[19px] w-[60px] text-[16px] leading-5 font-medium whitespace-nowrap sm:mt-[22px]">
      ...
      <div className="flex items-center justify-between px-5 py-3.5">
        <p className="text-app-text-dark text-xl leading-[120%] font-bold capitalize">
          Итого
        </p>
        <p className="text-app-text-dark text-xl leading-[120%] font-bold capitalize">
