...
/* CopyMark imported from @/shared/ui/CopyMark */
...
function UserIcon() {
  return (
    ...
    >
      <path
        d="M16.819 7.47485C16.6199 10.1597 14.5846 12.3499 12.3503 12.3499C10.1159 12.3499 8.07702 10.1602 7.88151 7.47485C7.67839 4.68188 9.65885 2.59985 12.3503 2.59985C15.0417 2.59985 17.0221 4.73267 16.819 7.47485Z"
        stroke="black"
        strokeWidth="2"
        strokeLinecap="round"
      ...
      />
      <path
        d="M12.3497 15.5999C7.93176 15.5999 3.44778 18.0374 2.61801 22.6381C2.51797 23.1927 2.8318 23.7249 3.41223 23.7249H21.2872C21.8682 23.7249 22.182 23.1927 22.082 22.6381C21.2517 18.0374 16.7677 15.5999 12.3497 15.5999Z"
        stroke="black"
        strokeWidth="2"
        strokeMiterlimit="10"
      />
...
function CardIcon() {
  return (
    ...
    >
      ...
      />
      <path
        d="M25.333 9.66675C25.8795 9.66693 26.333 10.1202 26.333 10.6667C26.333 11.2133 25.8795 11.6666 25.333 11.6667H18.666C18.1193 11.6667 17.666 11.2134 17.666 10.6667C17.666 10.1201 18.1193 9.66675 18.666 9.66675H25.333Z"
        fill="black"
      />
      <path
        d="M25.333 9.66675C25.8795 9.66693 26.333 10.1202 26.333 10.6667C26.333 11.2133 25.8795 11.6666 25.333 11.6667H18.666C18.1193 11.6667 17.666 11.2134 17.666 10.6667C17.666 10.1201 18.1193 9.66675 18.666 9.66675H25.333Z"
      ...
      />
      <path
        d="M25.333 15C25.8797 15 26.333 15.4533 26.333 16C26.333 16.5467 25.8797 17 25.333 17H20C19.4533 17 19 16.5467 19 16C19 15.4533 19.4533 15 20 15H25.333Z"
        fill="black"
      />
      <path
        d="M25.333 15C25.8797 15 26.333 15.4533 26.333 16C26.333 16.5467 25.8797 17 25.333 17H20C19.4533 17 19 16.5467 19 16C19 15.4533 19.4533 15 20 15H25.333Z"
      ...
      />
      <path
        d="M25.333 20.3333C25.8795 20.3334 26.333 20.7867 26.333 21.3333C26.333 21.8798 25.8795 22.3331 25.333 22.3333H22.666C22.1193 22.3333 21.666 21.8799 21.666 21.3333C21.666 20.7866 22.1193 20.3333 22.666 20.3333H25.333Z"
        fill="black"
      />
      <path
        d="M25.333 20.3333C25.8795 20.3334 26.333 20.7867 26.333 21.3333C26.333 21.8798 25.8795 22.3331 25.333 22.3333H22.666C22.1193 22.3333 21.666 21.8799 21.666 21.3333C21.666 20.7866 22.1193 20.3333 22.666 20.3333H25.333Z"
      ...
      />
      <path
        d="M11.333 9.22656C13.2129 9.22656 14.7469 10.7598 14.7471 12.6396C14.7471 14.5196 13.213 16.0537 11.333 16.0537C9.45312 16.0536 7.91992 14.5196 7.91992 12.6396C7.92006 10.7598 9.4532 9.2267 11.333 9.22656ZM11.333 11.2266C10.5599 11.2267 9.92006 11.8665 9.91992 12.6396C9.91992 13.4129 10.5598 14.0536 11.333 14.0537C12.1063 14.0537 12.7471 13.413 12.7471 12.6396C12.7469 11.8664 12.1063 11.2266 11.333 11.2266Z"
        fill="black"
      />
      <path
        d="M11.333 9.22656C13.2129 9.22656 14.7469 10.7598 14.7471 12.6396C14.7471 14.5196 13.213 16.0537 11.333 16.0537C9.45312 16.0536 7.91992 14.5196 7.91992 12.6396C7.92006 10.7598 9.4532 9.2267 11.333 9.22656ZM11.333 11.2266C10.5599 11.2267 9.92006 11.8665 9.91992 12.6396C9.91992 13.4129 10.5598 14.0536 11.333 14.0537C12.1063 14.0537 12.7471 13.413 12.7471 12.6396C12.7469 11.8664 12.1063 11.2266 11.333 11.2266Z"
  ...
  return (
    <section className="animate-fadeIn">
      <div className="mb-4 flex flex-wrap items-center gap-3">
        <Link
          href="/admin/orders"
          className="bg-app-card inline-flex h-11.5 w-27.75 items-center gap-2.5 rounded-[15px] px-3.25 py-3 text-[16px] leading-5 font-medium text-[#000000]"
        >
          <span>Заказы</span>
          <span className="text-xl leading-none">›</span>
        </Link>

        <span className="bg-app-card inline-flex h-11.5 items-center rounded-[15px] px-3.25 py-3 text-[16px] leading-5 font-medium text-[#000000]">
          №{order.orderNumber}
      ...
      <div className="grid gap-6 xl:grid-cols-[minmax(0,1fr)_594px]">
        <div>
          ...
          <button
            type="button"
            className="bg-app-card mt-4 inline-flex h-11.5 w-40.25 items-center gap-2.5 rounded-[15px] px-3.25 py-3 text-[16px] leading-5 font-medium text-[#000000]"
          >
            История заказа
          </button>

          <article className="bg-app-card mt-4 rounded-[20px] p-5">
            <div className="mb-5 flex flex-wrap items-start justify-between gap-3">
              <div className="flex flex-wrap items-center gap-2 text-[16px] leading-5 font-medium text-[#7e7e7e]">
                ...
                <span className="bg-app-text-dark rounded-full px-3 py-1 text-[16px] leading-5 font-medium text-white">
                  Оригинал
                </span>
              </div>
        ...
        <aside className="space-y-4">
          <article className="bg-app-card h-25 rounded-[20px] px-6.25 py-6.25">
          ...
          <article className="bg-app-card overflow-hidden rounded-[20px]">
            <InfoRow
              icon={<PinIcon />}
              title="Пункт выдачи"
              lineOne={
                order.pickupAddress ?? 'Москва, Никольская ул., 24, стр 3'
              }
          ...
          <article className="bg-app-card min-h-64.25 rounded-[20px] p-5">
            ...
            <div className="mt-6 flex items-end justify-between">
              <span className="text-app-text-dark text-[20px] leading-[120%] font-bold">
                Итого
              </span>
