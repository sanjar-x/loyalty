  ...
  return (
    <div className={styles.metricsGrid}>
      ...
      <div>
        ...
        <div className="flex items-center gap-1 text-base leading-5 font-medium text-[#7e7e7e]">
          <DateRangePicker
            value={dateRange}
          ...
          {hasRange && (
            <button
              ...
              className="cursor-pointer border-0 bg-transparent p-0 text-xl leading-none text-[#7e7e7e]"
