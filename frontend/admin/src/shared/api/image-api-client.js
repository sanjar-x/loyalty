...
if (!IMAGE_BACKEND_URL)
  console.warn('[image-api-client] IMAGE_BACKEND_URL is not set');
if (!IMAGE_BACKEND_API_KEY)
  console.warn('[image-api-client] IMAGE_BACKEND_API_KEY is not set');
