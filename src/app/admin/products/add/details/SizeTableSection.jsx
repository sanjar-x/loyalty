  ...
  return (
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M0.275664 0.277478C0.643216 -0.0924926 1.23914 -0.0924926 1.60669 0.277478L8 6.71285L14.3933 0.277478C14.7609 -0.0924926 15.3568 -0.0924926 15.7243 0.277478C16.0919 0.647448 16.0919 1.24729 15.7243 1.61726L8.66551 8.72252C8.29796 9.09249 7.70204 9.09249 7.33449 8.72252L0.275664 1.61726C-0.0918881 1.24729 -0.0918881 0.647448 0.275664 0.277478Z"
        fill="black"
      />
    </svg>
  );
...
export default function SizeTableSection() {
  ...
  function handleFileChange(event) {
    ...
    setPreviewAlt(file.name || 'Таблица размеров');
    setUrlValue('');
    event.target.value = '';
  }
  ...
  function applyUrlImage() {
    ...
    setPreviewUrl(nextUrl);
    setPreviewAlt('Таблица размеров по URL');
  }

  const canApplyUrl = Boolean(urlValue.trim());
  const showUrlAction = canApplyUrl;
        ...
        <div className={styles.sizeTableBody}>
          ...
          {previewUrl ? (
            ...
            >
              <img
                src={previewUrl}
                alt={previewAlt || 'Таблица размеров'}
