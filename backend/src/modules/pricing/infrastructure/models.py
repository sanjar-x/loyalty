...
# SkuPricingHistoryModel relocated to catalog.infrastructure.models per
# ADR-005a (commit 3/8 of REFACT-001 PR-S6) -- catalog owns SKU lifecycle
# audit storage. Imports of the model should now go through
# src.infrastructure.database.registry, which re-exports from catalog.
