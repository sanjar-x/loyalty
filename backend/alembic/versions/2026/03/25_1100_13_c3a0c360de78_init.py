...
Revision ID: c3a0c360de78
Revises:
Create Date: 2026-03-25 11:00:13.890915
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["family_id"],
            ["attribute_families.id"],
            name=op.f("fk_categories_family_id_attribute_families"),
            ondelete="SET NULL",
        ),
        sa.ForeignKeyConstraint(
            ["parent_id"],
    ...
    op.create_index(
        ...
        unique=True,
        postgresql_where=sa.text("role = 'MAIN' AND processing_status != 'FAILED'"),
        postgresql_nulls_not_distinct=True,
    )
    op.create_table(
        "skus",
