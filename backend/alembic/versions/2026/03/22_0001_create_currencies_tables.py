...
def upgrade() -> None:
    ...
    op.create_table(
        "currencies",
        sa.Column(
            "code", sa.String(3), primary_key=True,
            comment="ISO 4217 alpha-3 code (e.g. UZS, USD, EUR)",
        ),
        sa.Column(
            "numeric", sa.String(3), nullable=False, unique=True,
        ...
        sa.Column(
            "minor_unit", sa.SmallInteger, nullable=True,
    ...
    op.create_table(
        ...
        sa.Column(
            "currency_code", sa.String(3), nullable=False,
            comment="FK -> currencies.code",
        ),
        sa.Column(
            "lang_code", sa.String(12), nullable=False,
        ...
        sa.UniqueConstraint(
            "currency_code", "lang_code", name="uq_currency_lang",
        ),
    )
    ...
    op.create_table(
        "country_currencies",
        sa.Column(
            "country_code", sa.String(2), nullable=False,
